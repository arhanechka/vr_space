  ...
  return (
    <div className="center-content">
      ...
      <p className="display-3">
        Discover a world of excitement and immersion with our collection of
        captivating VR games. Each game is meticulously crafted to deliver
        unparalleled experiences that challenge your senses and imagination.
      </p>
